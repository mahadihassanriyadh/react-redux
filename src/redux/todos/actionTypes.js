export const LOADED = "todos/loaded"; // for loading our tasks from the server
...
export const DELETED = "todos/deleted"; // to delete a task / todo from the todo list.
export const ALLCOMPLETED = "todos/allCompleted"; // mark all the tasks / todos in the list as completed.
export const CLEARCOMPLETED = "todos/clearCompleted"; // delete all the completed tasks
